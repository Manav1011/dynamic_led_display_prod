    ...
    try:
        while True:
            ...
            if time_to_send == 0:
                ...
                await send_messages(websocket, data={'client': 'producer', 'device': 'rs485', 'action': 'stream',
            ...
            if time_to_store == 0:
                ...
                await send_messages(websocket, data={'client': 'producer', 'device': 'rs485', 'action': 'store',
                                                     'frame': dict_to_store})
                stored_list = []
                time_to_store = 60
...
if __name__ == "__main__":
    async def connect_to_websocket():
        async with websockets.connect(f"ws://192.168.1.4:8000/ws/serial_communication/producer/") as websocket:
            ...
            serial_task = asyncio.ensure_future(read_serial_port("COM4",websocket=websocket))
